#!/usr/bin/env swift
//
// macOS Vision OCR / image-description / layout script.
//
// Derived from free-vision-skill
// (https://github.com/niyongsheng/free-vision-skill),
// Copyright (c) 2026 Nico, distributed under the MIT License.
// See the package LICENSE file for the full license text.
